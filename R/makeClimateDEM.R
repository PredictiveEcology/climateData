#' Function to create a DEM for use in climateNA
#'
#'
...
#' @param dataPath the directory to which gtopo30Canada is downloaded
...
#' @importFrom raster resample crop projectRaster buffer trim
#' @importFrom sp spTransform CRS
#' 
#' @rdname makeClimateDEM
makeClimateDEM <- function(studyArea, arcSecRes = c(210, 210), bufferArcSec, DEMdestinationPath, destinationPath, filename2) {
